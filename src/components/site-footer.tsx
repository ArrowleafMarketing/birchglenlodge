      ...
      <div className="mx-auto w-full max-w-[1280px] px-5 py-16 sm:px-8">
        <div className="grid gap-12 md:grid-cols-[1.6fr_1fr_1fr]">
          ...
          <Reveal className="max-w-md">
            <Link href="/" aria-label="Birch Glen Lodge home" className="inline-block">
              <Image
                src={site.footerLogo}
                alt="Birch Glen Lodge & Motel"
                width={800}
                height={100}
            ...
            <p className="mt-6 text-[15px] leading-relaxed text-ink/70">
              Located next door to Kelly&apos;s Whitewater Park in Cascade,
              Birch Glen is right in the heart of Valley County with convenient
              access to outdoor activities including rafting, fishing, golfing,
              swimming, kayaking, boating, water skiing, hiking, biking,
              hotsprings, ice fishing, snow skiing, cross-country skiing,
          ...
          {/* Contact */}
          <Reveal delay={90}>
            <h2 className="h6 text-ink">Contact</h2>
          ...
          {/* Address */}
          <Reveal delay={180}>
            <h2 className="h6 text-ink">Address</h2>
            <ul className="mt-5 space-y-3 text-[15px] text-ink/70">
