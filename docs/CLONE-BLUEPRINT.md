...
- Logo → `/` : **`BIRCH-GLEN-LODGE-1.png`** (663×250) ← _NOT the wide wordmark_
...
- Book button (right): label **"Book Now"** → https://booking.thebirchglenlodge.com/ ← _not "Book A Room"_
...
- Bottom bar (right-aligned desktop): "2026, Birch Glen Lodge" (plain) · Privacy Policy → /privacy-policy/ · Terms of Service → /terms-of-service/
